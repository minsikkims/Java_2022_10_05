...
//		System.out.println("a-b="+ (a - b));
//		System.out.println("a*b="+ (a * b));
//		System.out.println("b/a="+ (b / a)); //몫을 구하는 작업-나누기
//		System.out.println("a%%b="+ (a % b));//나누기-나머지(1,.짝홀수구분,2.배수구분,3자리수제한,4.끝자리구하기)
...
//		System.out.println("A >= B : "+ (a >= b));
//		System.out.println("A <= B : "+ (a <= b));
//		System.out.println("A != B : "+ (a != b));//다르냐는 물음
		
		
		
		//논리연산자 
		//AND 연산자   && :  (true)&&(true) = true(둘다 동일해야함)
